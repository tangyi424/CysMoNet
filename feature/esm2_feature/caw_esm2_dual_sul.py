...
def plot_dual_results(A_pos, w_pos, A_neg, w_neg, save_prefix):
    ...
    ax1.set_title("ESM-2 Attention Analysis for S-sulfhydration Prediction",
    ...
    # 添加模型信息标注
    ax2.text(0.98, 0.02, "Model: ESM-2 | Task: S-sulfhydration Prediction",
...
def main():
    ...
    A_pos, w_pos = compute_mean_attention_esm2(seqs_pos, "pos", os.path.join(out_dir, "CAW"))
    A_neg, w_neg = compute_mean_attention_esm2(seqs_neg, "neg", os.path.join(out_dir, "CAW"))
