...
save_npz(merged_full,  "../data/esm2_pooled_fea/merged_full.npz")
save_npz(merged_left,  "../data/esm2_pooled_fea/merged_left.npz")
save_npz(merged_right, "../data/esm2_pooled_fea/merged_right.npz")