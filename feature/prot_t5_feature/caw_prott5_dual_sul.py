...
input_pos = "/home/lichangyong/documents/tangyi/SulMoNet/data/all_pos.txt"
input_neg = "/home/lichangyong/documents/tangyi/SulMoNet/data/output_neg.txt"

out_dir = "/home/lichangyong/documents/tangyi/SulMoNet/data/"
...
def plot_dual_results(A_pos, w_pos, A_neg, w_neg, save_prefix):
    ...
    ax1.set_title("ProtT5 Attention Analysis for S-sulfhydration Prediction",
    ...
    ax2.text(
        ...
        "Model: ProtT5 | Task: S-sulfhydration Prediction",
        transform=ax2.transAxes,
        fontsize=9, fontstyle='italic',
    ...
    plt.tight_layout()
    plt.savefig(f"{save_prefix}_prot_t5_sulfhydration_analysis.png",
                dpi=600, bbox_inches='tight', facecolor='white')
    plt.close()

    print(f"✅ Saved figure: {save_prefix}_prot_t5_sulfhydration_analysis.png")
...
def main():
    ...
    A_pos, w_pos = compute_mean_attention(seqs_pos, "pos", os.path.join(out_dir, "CAW"))
    A_neg, w_neg = compute_mean_attention(seqs_neg, "neg", os.path.join(out_dir, "CAW"))

    plot_dual_results(A_pos, w_pos, A_neg, w_neg, os.path.join(out_dir, "CAW"))
