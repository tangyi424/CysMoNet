...
# 正样本（1）
# -------------------------
emb_full_1  = inspect_npz("/home/lichangyong/documents/tangyi/SulMoNet/data/prott5_full.npz")
emb_left_1  = inspect_npz("/home/lichangyong/documents/tangyi/SulMoNet/data/prott5_left.npz")
emb_right_1 = inspect_npz("/home/lichangyong/documents/tangyi/SulMoNet/data/prott5_right.npz")

# -------------------------
# 负样本（2）
# -------------------------
emb_full_2  = inspect_npz("/home/lichangyong/documents/tangyi/SulMoNet/data/prott5_full_2.npz")
emb_left_2  = inspect_npz("/home/lichangyong/documents/tangyi/SulMoNet/data/prott5_left_2.npz")
emb_right_2 = inspect_npz("/home/lichangyong/documents/tangyi/SulMoNet/data/prott5_right_2.npz")
...
save_npz(merged_full,  "../data/prott5_pooled_fea/merged_full.npz")
save_npz(merged_left,  "../data/prott5_pooled_fea/merged_left.npz")
save_npz(merged_right, "../data/prott5_pooled_fea/merged_right.npz")