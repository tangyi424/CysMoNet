...
if __name__ == "__main__":
    ...
    parser.add_argument("--folder_a", type=str, default="./Pooled_ProtT5+atom",  help="第一个文件夹路径")
    parser.add_argument("--folder_b", type=str, default="./blosum_fea",  help="第二个文件夹路径")
    parser.add_argument("--out", type=str, default="./Pooled_ProtT5+atom+blosum62", help="输出文件夹")
